...
// This writes assembly for if statments
void if_to_asm(global &globals, std::vector<std::string> &file, int location)
{
	// This should go from the "if" to the '{' and use the function expression_to_asm on it
}
